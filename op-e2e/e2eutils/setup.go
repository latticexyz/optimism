...
func MakeDeployParams(t require.TestingT, tp *TestParams) *DeployParams {
	...
	deployConfig.DaChallengeWindow = tp.DaChallengeWindow
	deployConfig.DaResolveWindow = tp.DaResolveWindow
...
func Setup(t require.TestingT, deployParams *DeployParams, alloc *AllocParams) *SetupData {
	...
	rollupCfg := &rollup.Config{
		...
		DaChallengeContractAddress: l1Deployments.DataAvailabilityChallengeProxy,
		DaChallengeWindowSize:      deployConf.DaChallengeWindow,
		DaResolveWindowSize:        deployConf.DaResolveWindow,
	}
	...
	return &SetupData{
		...
		DaCfg: &damgr.Config{
			DaChallengeContractAddress: l1Deployments.DataAvailabilityChallengeProxy,
			ChallengeWindow:            deployConf.DaChallengeWindow,
			ResolveWindow:              deployConf.DaResolveWindow,
			SequencerWindow:            deployConf.SequencerWindowSize,
		},
	}
}
