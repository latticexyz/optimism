...
type AltDAParamGeneric func(p *e2eutils.TestParams)
...
func (a *L2AltDA) ActSubmitGenericCommitments(t helpers.Testing, n int) {
...
func TestAltDABatched_Derivation(gt *testing.T) {
	...
	harness.ActSubmitGenericCommitments(t, 2)
...
func TestAltDABatched_SequencerStalledMultiChallenges(gt *testing.T) {
	...
	a.ActSubmitGenericCommitments(t, 2)
